...
def hello():
    if request.method=='POST':
        ...
        data = "apikey=" + 'Aq29bXgMWqX8rtAnvCiOd7l44Xo7QhSbI-ulZiEFoJ2C' + "&grant_type=urn:ibm:params:oauth:grant-type:apikey"
        ...
        response_scoring = requests.post(
            'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/964d0d0f-ff48-427c-99c3-857c0231472a/predictions?version=2020-11-06',
